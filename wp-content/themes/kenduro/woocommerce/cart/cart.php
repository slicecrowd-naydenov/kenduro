...
<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
	...
	<h3 class="semibold cart-title">Завърши поръчката</h3>
	<div class="collapse show" id="collapseExample">
		...
		<ul class="custom-cart-list">
			...
			?>
					<li class="custom-cart-list__item woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
		...
		?>
			<div id="custom-total">
				...
				<h2 class="primary semibold">
					<span id="total"><?php echo WC()->cart->cart_contents_total; ?></span>
					лв.
				</h2>
			</div>
		<?php
...
<?php 
Load::organisms('modals/confirmation_delete_product/index');
